...
<div class="w-full h-screen sm:w-80 sm:h-min font-[MG] font-bold font-stretched">
    <div class="w-full h-full sm:rounded-xl sm:overflow-hidden bg-slate-50">
        <div class="relative w-full h-[22.5rem] overflow-hidden bg-cover bg-no-repeat bg-center z-0"
            ...
            <div class="absolute w-full h-56 bottom-0 bg-gradient-to-b from-transparent to-slate-50 z-10 pointer-events-none">
            </div>
        </div>
        <div class="px-6 pb-4">
            <div class="relative -mt-[20%] pb-4 text-2xl font-black z-30 text-slate-700 font-stretched">
                Explore new places around the world
            </div>
            <div class="relative mt-0 pb-4 text-sm font-medium font-condensed text-slate-600">
                Sign up for free and receive hand-picked offers for the best destinations with great discounts
            </div>
            <button
                    class="w-full text-sm font-[MG] font-medium font-condensed border-none rounded-lg p-2 text-slate-50 bg-slate-600">
                View Offers
            </button>
            <div class="flex pt-4 gap-2 text-[0.625rem] font-[MG] font-medium text-slate-950">
                <svg fill="none" height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg">
                    <path class="fill-slate-950"
